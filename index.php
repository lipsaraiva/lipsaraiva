...
<head>
    <title>Saraiva - Soluções para Web</title> 
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p>Endereço: Av. Paulista, 1000, São Paulo</p>
                </div>
                <div class="col-md-4">
                    <h3>Links Úteis</h3>
                    <p><a href="#inicio" class="text-white">Início</a></p>
                    <p><a href="#works" class="text-white">Trabalhos</a></p>
                    <p><a href="#sobre" class="text-white">Sobre</a></p>
            ...
            <div class="mt-4">
                <p>&copy; 2025 Todos os direitos reservados | Empresa</p>
            </div>
        </div>
    </footer>
